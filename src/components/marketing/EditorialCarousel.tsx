...
export function EditorialCarousel({
  ...
  // Section is already full-bleed in the page stack - skip w-screen breakout
  // (100vw + scrollbar shifts gutters left vs Container sections).
  const swiperKey = `editorial-${contentInsetPx}-${slides.length}-${titleId}`;
    ...
    <Section id={id} ariaLabelledby={titleId} className="overflow-x-clip">
      ...
      >
        ...
        <Swiper
          ...
          slidesOffsetAfter={contentInsetPx}
          mousewheel={{
            forceToAxis: true,

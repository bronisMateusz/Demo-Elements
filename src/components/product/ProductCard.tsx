      ...
      <a href={product.href} className="block no-underline">
        <div className="relative mb-4 aspect-4/5 overflow-hidden bg-neutral-50">
          <img
            ...
            className="size-full object-cover transition-transform duration-slow ease-luxury group-hover:scale-[1.02] group-focus-within:scale-[1.02]"
            loading="lazy"
          />
        </div>
        <p className="mb-1 font-body text-xs uppercase tracking-[0.12em] text-neutral-500">
          {product.brand}
        </p>

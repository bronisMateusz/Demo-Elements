    ...
    >
      <Container size="wide" className="overflow-visible">
        ...
        <div className="grid gap-4 overflow-visible lg:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)] lg:items-start lg:gap-x-12 xl:grid-cols-2 xl:gap-x-12">
          ...
          <div className="min-w-0 max-lg:-mx-[clamp(0.75rem,2.222vw,2.5rem)] lg:sticky lg:top-[var(--site-header-bar-height,7.25rem)] lg:h-[calc(100svh-var(--site-header-bar-height,7.25rem))] lg:overflow-x-clip xl:top-29 xl:h-[calc(100svh-7.25rem)]">

...
export function VariantChip({ label, selected, unavailable, onClick }: VariantChipProps) {
  return (
    <button
      ...
      className={cn(
        "variant-chip relative z-10 inline-flex min-h-11 min-w-17 items-center justify-center rounded-xs border-0 bg-transparent px-3 py-2 text-sm font-medium leading-none",

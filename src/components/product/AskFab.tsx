...
export function AskFab({
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center gap-2 border border-neutral-300/80 bg-neutral-0 px-3 py-2 shadow-2 max-lg:border-x-0 max-lg:border-b-0 lg:gap-5 lg:px-5 lg:py-4">

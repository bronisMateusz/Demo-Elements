            ...
            <div className="relative z-10 flex min-w-0 flex-col gap-4 md:gap-6">
              ...
              <div className="flex min-w-0 flex-col gap-3 md:gap-5">
                <div
                  className={cn(
                    titleIconClass &&
                      "flex min-w-0 items-center gap-3 font-heading text-h2 leading-[1.1] tracking-tight font-medium",
                  )}
                >
                  {titleIconClass ? (
                    <i
              ...
              <motion.div
                className="flex min-w-0 flex-col items-stretch gap-3 sm:flex-row sm:flex-wrap sm:items-center sm:justify-start"
              ...
              {note ? (
                <p className="m-0 font-body text-sm text-neutral-600">{note}</p>
              ) : null}
            </div>
          </div>
        </div>
